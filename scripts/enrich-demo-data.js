...
function makeNotifications() {
  ...
  const rows = [
    ...
    },
    {
      ...
      body: '₫2.000.000 was added to your wallet.',
    ...
    },
    {
      ...
      body: 'Book this weekend to earn 2x loyalty points.',
      action_route: '/home',
      read: true,
    },
  ];
  ...
  for (const roomId of roomIds) {
    for (let day = 0; day < 75; day++) {
      ...
      if (bucket < 12) {
        ...
        priceOverride = 1500000 + ((bucket % 3) * 150000);
      } else {
