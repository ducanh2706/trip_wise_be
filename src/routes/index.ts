...
router.use('/provider/dashboard', requireAuth, providerDashboardRoutes);
router.use('/provider/finance', requireRole('PROVIDER'), providerFinanceRoutes);
router.use('/provider/listings', requireAuth, providerListingsRoutes);
router.use('/provider/vip', requireAuth, providerVipRoutes);
